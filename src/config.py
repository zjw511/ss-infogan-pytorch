...
net_arg.add_argument('--dim_c_cont', type=int, default=1,
...
net_arg.add_argument('--dim_z', type=int, default=117,
...
training_arg.add_argument('--num_epoch', type=int, default=500)
training_arg.add_argument('--lr_G', type=float, default=0.0002)
training_arg.add_argument('--lr_D', type=float, default=0.0002)
# training_arg.add_argument('--lr_CR', type=float, default=0.001)
training_arg.add_argument('--lr_CR', type=float, default=0.0002)
...
training_arg.add_argument('--lambda_cont', type=float, default=0)
training_arg.add_argument('--alpha', type=float, default=1,
                          help="Hyperparameter for Contrastive Loss")
training_arg.add_argument('--unsup', type=float, default=0.8)
training_arg.add_argument('--sup', type=float, default=18)
